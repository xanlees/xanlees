...
p, issuer, lottery-branch/*, (edit)|(show)|(delete)
p, issuer, lottery-branch, (list)|(create)
...
p, staff, profile/user-profile/*, (edit)|(show)|(delete)
p, staff, profile/user-profile, (list)|(create)
p, user, profile/user-profile/*, (edit)|(show)|(delete)
p, user, profile/user-profile, (list)|(create)
p, admin, user, (list)|(create)
p, admin, user/*, (edit)|(show)|(delete)
...
p, admin, past-employee/*, (edit)|(show)|(delete)
p, admin, past-employee, (list)|(create)
p, user, my-profile/*, (edit)|(show)|(delete)
p, user, my-profile, (list)|(create)
p, staff, my-profile/*, (edit)|(show)|(delete)
p, staff, my-profile, (list)|(create)
p, user, log-out, (create)
