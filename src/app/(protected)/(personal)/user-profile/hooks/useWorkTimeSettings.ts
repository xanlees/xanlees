...
export function useWorkTimeSettings<T extends BaseRecord>({ branchId, day, pageSize }: { branchId: number[], day: string, pageSize: number }): GetListResponse<T> | typeof defaultData {
